...
# Rust via rustup (~/.cargo/bin must beat any Homebrew rustc for
# cross-target builds like wasm32; .zshenv sources cargo/env too early —
# path_helper and brew shellenv would demote it)
