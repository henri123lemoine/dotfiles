...
Provide a code review for the given pull request. Output the review locally unless the user explicitly asked you to post a GitHub comment.
...
- For the output format, follow this format precisely (assuming for this example that you found 3 issues):
